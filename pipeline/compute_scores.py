...
Note : data/conflicts.json et data/trade.json sont curés à la main et
       ne sont pas régénérés ici.
"""
...
def run():
    ...
    # conflicts.json et trade.json sont des données curées à la main :
    # jamais régénérées par le pipeline.
